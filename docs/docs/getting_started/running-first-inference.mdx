...
This guide assumes you have already completed the steps in [Local Setup](/docs/building_automations/installation).
You should have already [recorded your first automation](/docs/getting_started/recording-first-automation) and saved it as a recording in the Optexity dashboard.
