...
Optexity defaults to `gemini/gemini-2.5-flash`, but runs on any model [LiteLLM](https://docs.litellm.ai/docs/providers) supports. Set `LLM_MODEL` with its own key:
